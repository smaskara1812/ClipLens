...
urlpatterns = [
    ...
    path('admin-panel/usage/',       views.org_usage_page,          name='org_usage'),
    path('admin-panel/ai-features/', views.org_ai_features,         name='org_ai_features'),
    path('admin-panel/email/',       views.org_email_settings,      name='org_email_settings'),
    path('admin-panel/email/log/',   views.org_email_log,           name='org_email_log'),
    path('admin-panel/support/',                 views.org_support_list,   name='org_support_list'),
    ...
    path('admin-panel/topup/',       views.org_topup_page,          name='org_topup'),
    path('admin-panel/topup/buy/',     views.org_topup_purchase,      name='org_topup_purchase'),
    path('admin-panel/topup/success/', views.org_topup_success,       name='org_topup_success'),
    path('admin-panel/topup/cancel-addon/<int:addon_id>/', views.org_storage_addon_cancel, name='org_addon_cancel'),
    path('admin-panel/topup/expire-pack/<int:pack_id>/', views.org_credit_pack_expire, name='org_pack_expire'),
    path('admin-panel/billing/',         views.org_billing_page,        name='org_billing'),
    path('admin-panel/billing/portal/',  views.org_portal_redirect,     name='org_billing_portal'),
    path('admin-panel/billing/cancel-plan/', views.org_plan_cancel,     name='org_plan_cancel'),
    path('admin-panel/plan/',            views.org_plan_upgrade_page,   name='org_plan_upgrade'),
    path('admin-panel/plan/change/',     views.org_plan_change,         name='org_plan_change'),
    path('admin-panel/deleted/',     views.admin_trash_page,        name='admin_trash'),
    ...
    path('api/videos/<uuid:video_id>/subtitles/translate/',               views.subtitle_translate),
    ...
    path('api/faces/<int:identity_id>/forget/',                            views.face_identity_forget,        name='face_identity_forget'),
    path('api/faces/<int:identity_id>/export/',                            views.face_identity_export,        name='face_identity_export'),
    path('api/faces/<int:identity_id>/export/<str:export_id>/status/',     views.face_identity_export_status, name='face_identity_export_status'),
    path('admin-panel/audit-log/',                                         views.org_audit_log,               name='org_audit_log'),
    ...
    path('api/photos/<uuid:photo_id>/restore/',                            views.photo_restore),
    path('api/photos/<uuid:photo_id>/purge/',                              views.photo_purge),
